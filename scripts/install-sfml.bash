...
mkdir build
cd build
cmake -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_C_COMPILER=clang -DCMAKE_INSTALL_PREFIX=$sfml -DSFML_DEPENDENCIES_INSTALL_PREFIX=$sfml -DSFML_MISC_INSTALL_PREFIX=$sfml -DSFML_BUILD_AUDIO=n -DSFML_BUILD_NETWORK=n  ..
make install
